...
/**
 * This is a custom recycler view adapter that is pre-made for this lesson.
 *
 * It sets text onto text view from the data list.
 *
 * It also shows how to add a simple click listener for the list item,
 * however we will learn how to do it in a better way in the next lesson.
 *
