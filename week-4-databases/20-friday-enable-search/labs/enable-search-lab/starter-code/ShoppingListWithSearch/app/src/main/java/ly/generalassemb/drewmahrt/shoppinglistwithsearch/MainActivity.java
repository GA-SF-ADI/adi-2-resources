...
public class MainActivity extends AppCompatActivity {
    ...
    private void handleIntent(Intent intent) {
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            Cursor cursor = ShoppingSQLiteOpenHelper.getInstance(MainActivity.this).searchNumbers(query);
            Toast.makeText(MainActivity.this,"Searching for "+query, Toast.LENGTH_SHORT).show();

            ListView listView = (ListView) findViewById(R.id.shopping_list_view);
            listView.setText("Number of "+query+" in the database: "+cursor.getCount());
