...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayAdapter<String> sameCoAdapter,bostonAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sameCompanyButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                String[] sameCompanyList = new String[]{same};
                sameCoAdapter = new ArrayAdapter<>(MainActivity.this,android.R.layout.simple_list_item_1,sameCompanyList);
                listView1.setAdapter(sameCoAdapter);
            }
        });
        ...
        bostonButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String[] bostonList = new String[]{boston};
                bostonAdapter = new ArrayAdapter<>(MainActivity.this,android.R.layout.simple_list_item_1,bostonList);
