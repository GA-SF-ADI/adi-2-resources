 ...
 *
 * Key part for the while-loops is to remember the following parts:
...
public class WhileLoops {
    /**
     * While loop iterating over an 'int'
     *
    ...
    public static void printUpTo(int stop){
        ...
        while (start < stop){ // 2) - See above
            System.out.println("While-loop (int) value: " + start + " out of: " + stop);
            start++; // 3) - See above
        }
        System.out.println("");
    }
    ...
    /**
     * While loop iterating over a 'long'
     *
     * Prints values starting from 0 and going to the stop value that is passed
     * in the function argument.
     *
    ...
    public static void printUpTo(long stop){
        ...
        while (start < stop){ // 2) - See above
            System.out.println("While-loop (long) value: " + start + " out of: " + stop);
            start++; // 3) - See above
        }
        System.out.println("");
    }
    ...
    /**
     * While loop iterating over a 'float'
     *
     * Prints values starting from 0 and going to the stop value that is passed
     * in the function argument.
     *
    ...
    public static void printUpTo(float stop){
        ...
        while (start < stop){ // 2) - See above
            System.out.println("While-loop (float) value: " + start + " out of: " + stop);
            start++; // 3) - See above
        }
        System.out.println("");
    }
    ...
    /**
     * While loop iterating over a 'double'
     *
     * Prints values starting from 0 and going to the stop value that is passed
     * in the function argument.
     *
    ...
    public static void printUpTo(double stop){
        ...
        while (start < stop){ // 2) - See above
            System.out.println("While-loop (double) value: " + start + " out of: " + stop);
            start++; // 3) - See above
        }
        System.out.println("");
    }
