...
public class ExampleDBHelper extends SQLiteOpenHelper {
    private static final String TAG = ExampleDBHelper.class.getName();
    ...
    private static ExampleDBHelper instance;

    public static ExampleDBHelper getInstance(Context context){
        if(instance == null){
            instance = new ExampleDBHelper(context);
        }
        return instance;
    }

    private ExampleDBHelper(Context context) {
