...
//TODO: Create a SpotifyObject that mirrors the string
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createMarvelResult();
        Log.d("MainActivity", turnMarvelResultIntoString(marvelResult));
        turnWeatherJsonIntoObject(WEATHER_JSON);
    }

    public WeatherResult turnWeatherJsonIntoObject(String json){
        Gson gson = new Gson();
        WeatherResult weatherResult = gson.fromJson(json, WeatherResult.class);
        Log.d("MainActivity", weatherResult.query.results.channel.item +"");
        return weatherResult;
    }

//    public String turnSpotifyJSONIntoObject(String json){
//
//    }

    public String turnMarvelResultIntoString(MarvelResult result){
        Gson gson = new Gson();
        return gson.toJson(marvelResult);
    }
