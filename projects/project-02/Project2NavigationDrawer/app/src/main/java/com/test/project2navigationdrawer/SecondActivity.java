...
public class SecondActivity extends AppCompatActivity {
    ...
    private void populateListViewFromDB() {
        ...
        final Item item1 = new Item("1", "lori heart bracelet", 1490.00, "yellow gold", "ruby", "cuff width is 1/2 in", "striking collection", R.drawable.id1);
        Item item2 = new Item("2", "chloe bracelet", 5790.00, "white gold", "diamond", "cuff width is 1/2 in", "Elegant Collection", R.drawable.id2);
        Item item3 = new Item("3", "olivia bracelet", 1890.00, "platinum", "sapphire", "cuff width is 1/2 in", "Classic Collection", R.drawable.id3);
