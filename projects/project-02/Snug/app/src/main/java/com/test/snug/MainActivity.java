 ...
 */
    private void insertHatData() {
        ...
        hatDatabase.addHat(0, R.drawable.a_s_america, "Oakland A’s", 50, "100% polyester", 0, "Plush and soft, this hat will keep you comfortable"
                , "black");
        ...
        hatDatabase.addHat(5, R.drawable.all_blue_mets, "New York Mets", 19.99, "50% wool 50% cotton ", 0, "Plush and soft, this hat will keep you comfortable"
                , "blue");
        ...
        hatDatabase.addHat(10, R.drawable.all_read_angels, "LA Angels", 19.99, "50% polyester 50% cotton ", 0, "Plush and soft, this hat will keep you comfortable"
                , "read");
        ...
        hatDatabase.addHat(15, R.drawable.army_reds, "Cincinnati Reds", 19.99, "50% polyester 50% wool ", 0, "Plush and soft, this hat will keep you comfortable"
                , "borwn");
        ...
        hatDatabase.addHat(20, R.drawable.black_miami, "Miami Marlins", 19.99, "100% cotton", 0, "Plush and soft, this hat will keep you comfortable"
                , "black");
        ...
        hatDatabase.addHat(25, R.drawable.black_top_baltimore, "Baltimore Orioles", 29.99, "100% wool", 0, "Plush and soft, this hat will keep you comfortable"
                , "black");
        ...
        hatDatabase.addHat(30, R.drawable.blue_rangers, "Texas Rangers", 29.99, "100% polyester", 0, "Plush and soft, this hat will keep you comfortable"
                , "blue");
        hatDatabase.addHat(31, R.drawable.blue_top_brewers, "Milwaukee Brewers", 29.99, "100% wool", 0, "Great for a day at the beach!", "blue");
        hatDatabase.addHat(32, R.drawable.blue_top_New Yorkmets, "New York Mets", 50, "100% cotton", 0, "Play the outfield with confidence", "blue");
        ...
        hatDatabase.addHat(35, R.drawable.brewers_glove, "Milwaukee Brewers", 29.99, "50% wool 50% cotton ", 0, "Plush and soft, this hat will keep you comfortable"
                , "blue");
        ...
        hatDatabase.addHat(40, R.drawable.florida, "Miami Marlins", 39.99, "50% polyester 50% cotton ", 0, "Plush and soft, this hat will keep you comfortable"
                , "black");
        ...
        hatDatabase.addHat(45, R.drawable.light_blue_90s_seattle, "Seattle Mariners", 50, "50% polyester 50% wool ", 0, "Plush and soft, this hat will keep you comfortable"
                , "blue");
        ...
        hatDatabase.addHat(50, R.drawable.old_school_blue_cardinals, "St. Louis Cardinals", 39.99, "100% cotton", 0, "Plush and soft, this hat will keep you comfortable"
                , "blue");
        "
        ...
        hatDatabase.addHat(55, R.drawable.orange_brim_sf, "San Francisco Giants", 39.99, "100% wool", 1, "Plush and soft, this hat will keep you comfortable"
                , "black");
        ...
        hatDatabase.addHat(58, R.drawable.orange_New York_mets, "New York Mets", 39.99, "50% polyester 50% cotton ", 1, "Turn a double play in this stylish hat", "blue");
        ...
        hatDatabase.addHat(60, R.drawable.orangebrimmets, "New York Mets", 50, "100% polyester", 1, "Plush and soft, this hat will keep you comfortable"
                , "blue");
        ...
        hatDatabase.addHat(65, R.drawable.red_blue_diamondbacks, "Arizona Diamondbacks", 9.99, "50% wool 50% cotton ", 1, "Plush and soft, this hat will keep you comfortable"
                , "black");
        ...
        hatDatabase.addHat(70, R.drawable.red_brim_indians, "Cleveland Indians", 9.99, "50% polyester 50% cotton ", 1, "Plush and soft, this hat will keep you comfortable"
                , "blue");
        ...
        hatDatabase.addHat(75, R.drawable.red_hat_twins, "Minnesota Twins", 9.99, "50% polyester 50% wool ", 1, "Plush and soft, this hat will keep you comfortable"
                , "red");
        ...
        hatDatabase.addHat(80, R.drawable.rockies_america, "Colorado Rockies", 14.95, "100% cotton", 1, "Plush and soft, this hat will keep you comfortable"
                , "black");
        ...
        hatDatabase.addHat(85, R.drawable.standard_a_s, "Oakland A’s", 14.95, "100% wool", 1, "Plush and soft, this hat will keep you comfortable"
                , "green");
        ...
        hatDatabase.addHat(90, R.drawable.texas_america, "Texas Rangers", 14.95, "100% polyester", 1, "Plush and soft, this hat will keep you comfortable"
                , "blue");
        ...
        hatDatabase.addHat(95, R.drawable.white_w_nats, "DC Nationals", 14.95, "50% wool 50% cotton ", 1, "Plush and soft, this hat will keep you comfortable"
                , "blue");
