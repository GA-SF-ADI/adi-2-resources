 ...
 */
public class CustomStudentListRecyclerViewAdapter extends RecyclerView.Adapter<CustomStudentListRecyclerViewAdapter.SampleViewHolder> {
    private static final String TAG = "Adapter";
    private ArrayList<String> data;
    public static OnRecyclerViewItemClickListener onRecyclerViewItemClickListener;
    ...
    public static class SampleViewHolder extends RecyclerView.ViewHolder {
        ...
        public SampleViewHolder(final View itemView) {
            ...
            studentNameTextView = (TextView) itemView.findViewById(R.id.student_item_recycler_view);
            studentImageView = (ImageView) itemView.findViewById(R.id.student_image_recycler_view);
    ...
    public CustomStudentListRecyclerViewAdapter(ArrayList<String> inComingData) {
    ...
    public void onBindViewHolder(SampleViewHolder holder, int position) {
         ...
         */
        TextView textViewStudentName = holder.studentNameTextView;
        ImageView imageViewStudentImage = holder.studentImageView;

        // put our dataItem string as text into the text view
        textViewStudentName.setText(dataItem);

        // set the launcher icon as our image resource
        imageViewStudentImage.setImageResource(R.mipmap.ic_launcher);

        textViewStudentName.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {


                onRecyclerViewItemClickListener.onItemClick(getItemCount());
